                    ...
                    <div class="row">
                        <form action="{{ route('peserta.update', $peserta) }}" method="POST"
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control"
                                           value="{{ old('email', $peserta['authenticable']['email']) }}" name="email"
                                           id="email"
                                           required>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-5 col-md-offset-1">
                                <img src="{{ asset('storage/' . $peserta['foto'] ?? 'assets/img/avatar-placeholder.png') }}" alt="{{ $peserta['nama'] }}" class="user-image mt-1" height="60" />
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <button type="button" class="btn btn-primary" onclick="resetPassword('{{ $peserta['id'] }}', '{{ $peserta['nama'] }}')"><i
