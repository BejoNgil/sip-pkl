                    ...
                    <div class="row mb-2 clearfix">
                        <div class="col-md-12">
                            <button type="button" data-toggle="modal" data-target="#createNew"
                                ...
                                <i class="fa fa-plus"></i> Tambah Kategori Penilaian Baru
                            </button>
                        </div>
                    </div>
                </div>
    ...
    <script>
        function destroy(id, name) {
            swal({
                ...
                text: "Akan Menghapus Kategori Penilaian " + name,
                icon: "warning",
                buttons: true,
                dangerMode: true,
            }).then((willDelete => {
                if (willDelete) {
                    let theUrl = "{{ route('kategori.destroy', ':id') }}";
